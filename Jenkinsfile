pipeline{
    ...
    stages {
        ...
        stage('Checkout from Git'){
            steps{
                git branch: 'main', url: 'https://github.com/anilkumar-n-061/Netflix-Clone-DevSecOps-Project.git'
            }
        }
        ...
        stage('Deploy to container'){
            steps{
                sh 'docker run -d --name netflix -p 8081:80 anilkumar061/netflix:latest'
            }
        }
    ...
    post {
     always {
        emailext attachLog: true,
            ...
            to: 'anildevopsproject@gmail.com',
